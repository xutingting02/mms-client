<template>
    <div>
        ...
        <el-row class="row-group">
            <el-col :span="3">
                <el-button type="primary" icon="el-icon-plus" @click="addPurchase">进货</el-button>
            </el-col>
        ...
        <el-dialog
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="deletePurchaseOk">确 定</el-button>
            </span>
        </el-dialog>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        addPurchase: function() {
            this.$router.push('/manage/addPurchase')
        },
        // 渲染列表
        renderList: function() {
